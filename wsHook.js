...
/* 
 * modified original version of wsHook, full credit to skepticfx. I had to add unsafeWindow to WebSocket
 * the script I use uses grant permissions that override the native window calls
 */
